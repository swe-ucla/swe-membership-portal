...
const ManageEvents = () => {
  ...
  */
  ...
  const handleNextPage = () => {
    const totalPages = getTotalPages(activeTab === "upcoming" ? upcomingEvents : pastEvents);
          ...
          <div className="page-nav-container">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M15.8333 10H4.16667M4.16667 10L10 15.8333M4.16667 10L10 4.16667" stroke="currentColor" strokeWidth="1.67" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              PREVIOUS PAGE
            </button>
      ...
      <div className="tabs-container">
        <div className="tabs-header">
          <button
            ...
            onClick={() => {
              console.log('Switching to upcoming tab, events count:', upcomingEvents.length);
          ...
          <button
            ...
            onClick={() => {
              console.log('Switching to past tab, events count:', pastEvents.length);
              setActiveTab("past");
            }}
          >
